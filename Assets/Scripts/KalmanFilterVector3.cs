...
public class KalmanFilterVector3 {
	...
	public Vector3 Update(Vector3[] measurements, bool areMeasurementsNewestFirst = false, float? newQ = null, float? newR = null) {

		Vector3 result = Vector3.zero;
		int i = (areMeasurementsNewestFirst) ? measurements.Length - 1 : 0;

		while (i < measurements.Length && i >= 0) {
